...
window.__BAN_GUIDE = {
    sections: [
...

        {
            ...
            content: {
                description: '<p>Filter by card properties with <code>is:VALUE</code> or exclude with <code>not:VALUE</code> (equivalent to <code>-is:VALUE</code>).</p><p><strong>Generic:</strong> reserved, token, oversize, funny, wcd, commander, productless, gamechanger</p><p><strong>Frame:</strong> fullart, extendedart, showcase, reskin, borderless, gold, retro, future, foil, nonfoil, altfoil</p><p><strong>Language:</strong> japanese, phyrexian</p><p>Some values have shorthand aliases:</p>',
                table: [
