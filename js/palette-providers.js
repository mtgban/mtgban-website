...
(function () {
    ...
    var isTagOptions = [
        ...
        { value: 'oversize', label: 'Oversize', sublabel: 'oversized', group: 'Generic' },
        ...
        { value: 'gold', label: 'Gold-bordered', group: 'Generic' },
        { value: 'wcd', label: 'World Championship Deck', group: 'Generic' },
        { value: 'productless', label: 'Productless', group: 'Generic' },
        { value: 'ampersand', label: 'Ampersand (&)', group: 'Generic' },
        { value: 'foil', label: 'Foil', group: 'Generic' },
        { value: 'nonfoil', label: 'Non-foil', group: 'Generic' },
        { value: 'fullart', label: 'Full Art', sublabel: 'fa', group: 'Frame' },
        { value: 'extendedart', label: 'Extended Art', sublabel: 'ea', group: 'Frame' },
        ...
        { value: 'filterland', label: 'Filter land', group: 'Land cycle' },
        { value: 'surveilland', label: 'Surveil land', group: 'Land cycle' },
        { value: 'vergeland', label: 'Verge land', group: 'Land cycle' },
