...
// Loop coalesces a burst of signals into a single run after the quiet
// window elapses, then runs again for the next burst.
func TestLoopCoalescesBurst(t *testing.T) {
	...
	go Loop(signal, 20*time.Millisecond, run)
