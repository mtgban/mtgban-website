...
type Parser struct {
	// Backend is the card datastore this parser matches against. Nil means
	// an empty backend (below), so every row of one parser's operation
	// matches against the same snapshot.
