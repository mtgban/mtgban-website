...
// sealedPath is the /sealed/<set>/<slug> shape an inbound link arrives in.
func sealedPath(co *mtgmatcher.CardObject) string {
	return "/sealed/" + url.PathEscape(co.SetCode) + "/" + sealedSlug(co.Name)
}
