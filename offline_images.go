...
var offlineImagesManifestStore = &bucketstore.Store[imgmirror.Manifest]{
	MissingOK: true,
	Bucket: func(ctx context.Context) (simplecloud.ReadWriter, string, error) {
		...
		return bucket, imgmirror.JoinPath(Config.Datastore.OfflineImagesPath, "images-manifest.json"), nil
	},
}
