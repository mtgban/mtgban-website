...
const Pioneer: SubscriptionTier = { name: "Pioneer", description: "pioneer tier description", features: ["pioneer features"] }
const Modern: SubscriptionTier = { name: "Modern", description: "modern tier description", features: ["modern features"] }
const Legacy: SubscriptionTier = { name: "Legacy", description: "legacy tier description", features: ["legacy features"] }
const Vintage: SubscriptionTier = { name: "Vintage", description: "vintage tier description", features: ["vintage features"] }
const Free: SubscriptionTier = { name: "Free", description: "free tier description", features: ["free features"] }
