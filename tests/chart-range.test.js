...
// On the legacy read an archive error reaches the page as an empty chart the
// server marks no-store. Installing it would blank the drawn chart and record
// the ceiling as loaded, so no later range change would fetch again.
