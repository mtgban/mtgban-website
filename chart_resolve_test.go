...
func printings(finishes map[string]string) []printingFinish {
	...
	for _, finish := range []string{mtgmatcher.FinishNonfoil, mtgmatcher.FinishFoil, mtgmatcher.FinishEtched} {
		...
		if ok {
			out = append(out, printingFinish{Finish: finish, UUID: uuid})
		}
	}
	var extra []string
	...
	for _, finish := range extra {
		out = append(out, printingFinish{Finish: finish, UUID: finishes[finish]})
	}
	return out
}
...
var fabPrintings = []printingFinish{
	{Finish: "normal", UUID: "omn071_695162"},
	{Finish: "rainbowfoil", UUID: "omn071_695162_rainbow"},
}
...
func TestSubTypeForPrintingPositionalFallback(t *testing.T) {
	...
	lorcana := []printingFinish{
		{Finish: mtgmatcher.FinishNonfoil, UUID: "1459"},
		{Finish: mtgmatcher.FinishFoil, UUID: "1459_f"},
		{Finish: "rainbowpillars", UUID: "1459_rainbowpillars"},
	}
...
func TestSubTypeForPrintingPrintRuns(t *testing.T) {
	...
	yugioh := []printingFinish{
		{Finish: "1stedition", UUID: "hac1-en105_265004_1e"},
		{Finish: "limited", UUID: "hac1-en105_265004_ltd"},
		{Finish: "unlimited", UUID: "hac1-en105_265004_unl"},
	}
...
func TestSubTypeForPrintingGenericNames(t *testing.T) {
	...
	riftbound := []printingFinish{
		{Finish: mtgmatcher.FinishNonfoil, UUID: "rft001"},
		{Finish: mtgmatcher.FinishFoil, UUID: "rft001_foil"},
	}
